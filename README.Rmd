...
**Camrin D. Braun^1,2^\*, Benjamin Galuardi^3,4^, Simon R. Thorrold^2^**
...
1) Load the relevant tag data and establish a study area of interest.
2) Get the environmental data to base the likelihood calculations on.
3) Calculate the desired likelihoods (e.g. depth-temperature profiles, SST, etc)
4) Estimate parameters and run the model. Results are written out along the way.
5) Perform model checking and choose a final model.
