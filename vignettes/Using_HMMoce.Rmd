...
## ***tt here represents a loop as in for (tt in 1:length(L.idx)) so you can iterate through the
## possible combinations of likVec. See L.idx above.*** We will clarify this in a future package update.
