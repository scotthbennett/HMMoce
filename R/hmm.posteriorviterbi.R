...
#' Lember, J., and A. A. Koloydenko. 2014. Bridging Viterbi and posterior decoding: a generalized risk approach to hidden path inference based on hidden Markov models. Journal of Machine Learning Research, 15: 1-58.
...
hmm.posteriorviterbi <- function(pars, s, g, iniloc, dateVec, lims.lat, lims.lon){
