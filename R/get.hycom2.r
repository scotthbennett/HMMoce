...
#'   'temperature', 'mld', 'mlp' and others but is not checked
#'   for errors.
...
get.hycom2 <- function(limits, time, vars=c('temperature'), include_latlon=TRUE,
  ...
  expts = data.frame(
          ...
          url=c('http://ncss.hycom.org/thredds/ncss/GLBa0.08/expt_90.6/',
                ...
                'http://ncss.hycom.org/thredds/ncss/GLBa0.08/expt_91.2/'))
