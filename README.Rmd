...
`HMMoce` must be installed from Github as it is no longer available on CRAN. Install it using `devtools::install_github('camrinbraun/HMMoce')` or get the latest development version using `devtools::install_github('camrinbraun/HMMoce', ref='dev')`
